...
let seastuff = [
  ...
  { title: "Scallop", image: "scallops.jpg", price: 15.99 },
  { title: "shrmip", image: "shrimp.jpg", price: 21.99 },
  { title: "tuna", image: "tuna.jpg", price: 21.99 }
];
...
let Dessert = [
  ...
  { title: "Passion Berry", image: "passionberry.jpeg", price: 27.99 },
  { title: "oreocup", image: "oreocup.jpg", price: 15.99 }
];
...
function showSeafood(){
  ...
  */
  for(let i=0; i < seastuff.length; i++){
    let meast= seastuff[i];
    build += `<div class="card">
                <h3>${seastuff[i].title}</h3>
                <img src="images/${seastuff[i].image}">
                <p>${seastuff[i].price}</p>
              </div>`;
  }
